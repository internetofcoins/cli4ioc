  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>112/121</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">89.16% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>74/83</span>
      </div>
      <div class='fl pad1y space-right2'>
...
246
247
248</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (options.agent) <span class="cstat-no" title="statement not covered" >o.agent = options.agent</span>
  /* for debugging, method to get options and return */
  if (o.getopts) {
    var getopts = [ssl, options, o.data || false, o.success || false, o.error || <span class="branch-1 cbranch-no" title="branch not covered" >false]</span>
    return getopts
  }
&nbsp;
  // REQUEST
